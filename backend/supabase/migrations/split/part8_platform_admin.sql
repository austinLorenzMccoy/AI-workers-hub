-- ═══════════════════════════════════════════════════════════════════
-- Platform Admin — admin write access + helpers for managing platforms
-- and per-platform task columns without code deploys.
-- Run in Supabase SQL Editor after earlier parts.
-- ═══════════════════════════════════════════════════════════════════

-- ── Admin write policies: platforms ───────────────────────────────
...
-- ── Admin write policies: platform_task_columns ───────────────────
...
-- ── Helper: usage counts for admin UI ─────────────────────────────
-- Safe when optional tables (e.g. onboarding) are not yet applied.
...
-- ── Clone task columns from one platform to another ───────────────
-- Copies only active columns by default; skips keys that already exist.
