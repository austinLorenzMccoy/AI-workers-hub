...
-- top of the existing WorkersHub schema (parts 1-8 / init.sql +
-- platform_admin.sql). Nothing here drops or renames an existing
-- table, column, policy, or view — it only adds new columns (via
...
--
-- Run in Supabase SQL Editor AFTER part1-part8 (or after the combined
-- 20260612000000_init.sql + 20260807000000_platform_admin.sql).
